...
?>
        <option value="<?=$row['id_type']?>">ประเภทสินค้า : <?=$row['name_type']?></option>
        <?php
}
        ?>
      </select>
...
<div class="col-4">
  <button type="submit" name="button1" class="btn btn-primary">ค้นหา</button>
  <button type="submit" name="button2" class="btn btn-primary">ทั้งหมด</button>
</div>
  </div>
</form>
