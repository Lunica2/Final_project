...
session_start();
include 'config.php';
$sql="select * from tb_order t where order_id= '" . $_SESSION["order_id"] . "' ";
...
<table class="table table-hover">
  ...
  <tbody>
    <?php
    $sql1="select * from order_detail d,product p ,user_form uf where d.id_pro=p.id_pro and p.id_user=uf.id_member and d.id_order= '" . $_SESSION["order_id"] . "' ";
...
<a href="payment.php" class="btn btn-success">ชำระเงิน</a>
</div>
            </div>
        </div>
    </div>
