...
?>
        <li class="nav-item">
        <b class="nav-link" href="#"> ID : <?=$_SESSION["ad_id"]?> ยินดีต้อนรับ : <?=$_SESSION["ad_name"]?> สถานะผู้ใช้งาน : <b><?=$_SESSION["admin"]?></b></b>
        </li>
<?php
}
?>
                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        ...
                                        <a class="nav-link" href="add_type_product.php">เพิ่มประเภทสินค้า</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapse" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="edit_review.php">รีวิวสินค้า</a>
                                        <a class="nav-link" href="edit_rate.php">รีวิวเว็บไซต์</a>
                                        </nav>
                                    </div>
                                    <a class="nav-link" href="report_excuse_product.php">รายการขออนุญาตขายสินค้า</a>
