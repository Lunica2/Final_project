...
$ids=$_GET['id'];
$sql1 = "select * from pre_order_detail pd,product p ,pre_order po,user_form u ,payment_pre pp where pd.id_pro=p.id_pro and pd.id_pre=po.id_pre and po.id_member=u.id_member and po.id_pre=pp.id_pre and po.id_pre = '$ids' ";
