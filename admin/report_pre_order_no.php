    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i></button>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php
$sql = "select * from pre_order_detail pd,product p ,pre_order po,user_form u where pd.id_pro=p.id_pro and pd.id_pre=po.id_pre and po.id_member=u.id_member and pre_status='0' order by time_pre DESC";
