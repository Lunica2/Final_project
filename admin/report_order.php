...
if(($ddt1 != "") & ($ddt2 != "")){
    ...
    $sql = "select * from tb_order t,order_detail od where t.order_id=od.id_order and order_status='1' or order_status='3' and reg_date BETWEEN '$ddt1' and '$add_date'
    group by t.order_id order by reg_date DESC";
}else{
    $sql = "select * from tb_order t,order_detail od where t.order_id=od.id_order and order_status='1' or order_status='3' group by t.order_id order by reg_date DESC";
}
