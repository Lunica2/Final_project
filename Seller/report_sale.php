    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <div class="alert alert-primary h4 text-center mt-4" role="alert">รายงานยอดขายสินค้า</div>
...
if ($ddt1 != "" && $ddt2 == "") {
    ...
    $sql = "SELECT * FROM tb_order t
            ...
            WHERE id_user='$ids' AND od.order_pro_status='3'
...
?>
                        ...
                        <div class="text-end mt-3">
                            <b>ยอดขายที่ทำได้: <?=number_format($total_sum,2)?> ฿</b>
                        </div>
                    </div>
                </div>
            </div>
