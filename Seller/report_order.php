...
if(($ddt1 != "") & ($ddt2 != "")){
    ...
    $sql = "SELECT * FROM order_detail od,tb_order t,product p,user_form u WHERE od.id_order=t.order_id and od.id_pro=p.id_pro AND p.id_user='$ids'
            AND (order_pro_status='1' OR order_pro_status='2')
            AND reg_date BETWEEN '$ddt1' AND '$add_date'
            GROUP BY order_id 
            ORDER BY reg_date DESC";
}else{
    $sql = "SELECT * FROM order_detail od,tb_order t,product p,user_form u WHERE od.id_order=t.order_id and od.id_pro=p.id_pro AND p.id_user='$ids' AND (order_pro_status='1' OR order_pro_status='2') group by order_id  order by reg_date desc";
}
