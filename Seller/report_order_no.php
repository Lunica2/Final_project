                        ...
                        <div class="card mb-4 mt-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php
$sql = "select * from tb_order t,user_form u ,order_detail od,product p where t.id=u.id and t.order_id=od.id_order and od.id_pro=p.id_pro and id_user='$ids' and order_status='0' group by t.order_id order by reg_date DESC";
