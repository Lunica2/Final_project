...
<html lang="en">
    <head>
        ...
        <title>รรายงานรายละเอียดคำสั่งซื้อ Pre Order</title>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 mt-4">
                            <div class="card-header">
                                ...
                                แสดงข้อมูลการ Pre Order (ยกเลิก)
    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i></button>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php
$sql = "select * from pre_order po,user_form u ,pre_order_detail pod,product p where po.id_member=u.id_member and po.id_pre=pod.id_pre and pod.id_pro=p.id_pro and id_user='$ids' and pre_status='0' group by po.id_pre order by time_pre DESC";
