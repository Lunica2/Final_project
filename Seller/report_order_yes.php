    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i></button>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php 
$sql = "SELECT * FROM order_detail od,tb_order t,product p,user_form u WHERE od.id_order=t.order_id and od.id_pro=p.id_pro AND p.id_user='$ids' and order_pro_status='3' group by order_id  order by reg_date desc";
