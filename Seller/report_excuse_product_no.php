...
<html lang="en">
    <head>
        ...
        <title>รายงานการไม่อนุญาติขายสินค้า</title>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 mt-4">
                            <div class="card-header">
                                ...
                                แสดงข้อมูลการขออนุญาตขายสินค้า (ไม่อนุญาต)
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php
$sql = "select * from product p,user_form u where p.id_user=u.id_member and status_pro='0' and p.id_user='$ids' order by id_pro DESC";
