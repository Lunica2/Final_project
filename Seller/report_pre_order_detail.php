...
$sql = "select * from pre_order_detail pd,pre_order po,product p,user_form u where pd.id_pre=po.id_pre and pd.id_pro=p.id_pro and p.id_user=u.id_member and pd.id_pre='$ids'";
