                        ...
                        <div class="card mb-4 mt-4">
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
<?php
$sql = "select * from offer o,product p,user_form u where o.id_pro=p.id_pro and o.id_member=u.id_member and offer_status='0' and p.id_user='$ids' order by id_offer";
