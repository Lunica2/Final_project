                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql="SELECT * FROM review_table rt,product p,user_form u WHERE rt.user_id=u.id_member and rt.id_pro=p.id_pro and id_user='$ids' order by review_id ";
